    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(&this->m_socket,&CTcpSock::sig_recvData,&this->m_TCP_master,&C_MB_TCP_MASTER::slot_recvData);
    connect(&this->m_TCP_master,&C_MB_TCP_MASTER::sig_sendData,&this->m_socket,&CTcpSock::sendSockData);
}
